...
window.MEGABYTE = {
  ...
  queryTopics: ["General question", "Snowflake Academy", "Python Academy", "AWS Academy", "Prep Master", "Ink Scribe", "ATS Resume Builder", "Project Milano",
  ...
  projects: [
    ...
    },
    {
      ...
      status: "Live",
      icon: "☁️",
      summary: "A focused AWS learning hub for cloud concepts, certification practice, architecture, quizzes and progress tracking.",
      features: ["AWS topic guides and question bank", "Practice quizzes and flashcards", "Cloud architecture learning tools", "Track your learning progress"],
      stack: ["React", "TypeScript", "Vite"],
      preview: "assets/aws-prep-preview.svg",
      links: [{ label: "☁️ Launch AWS Academy", href: "AWS_PREP/dist/index.html", primary: true }],
      stats: [["AWS", "learning hub"], ["Interactive", "practice"]],
    },
    {
      id: "interview-prep",
      name: "Prep Master",
      status: "Live",
      icon: "🎯",
      summary: "Practice technical, coding and behavioral interview questions with interactive preparation tools.",
      features: ["Technical question bank", "Coding challenges and practice", "Behavioral interview preparation", "Interactive learning dashboard"],
      stack: ["React", "TypeScript", "Vite"],
      preview: "assets/interview-prep-preview.svg",
      links: [{ label: "🎯 Launch Prep Master", href: "INTERVIEW_PREP/dist/index.html", primary: true }],
      stats: [["Technical", "questions"], ["Coding", "practice"]],
    },
    {
      id: "notes-prep",
      name: "Ink Scribe",
      status: "Live",
      icon: "📝",
      summary: "A study workspace for reviewing AWS and interview topics with organized learning notes and practice.",
      features: ["Study notes and reference content", "AWS and technical topics", "Question banks and practice tools", "A dedicated workspace for revision"],
      stack: ["React", "TypeScript", "Vite"],
      preview: "assets/notes-prep-preview.svg",
      links: [{ label: "📝 Launch Ink Scribe", href: "NOTES_PREP/dist/index.html", primary: true }],
      stats: [["Study", "workspace"], ["Quick", "revision"]],
    },
  ],
  ...
  founders: [
    {
      ...
      projects: ["snowflake-academy", "python-academy", "aws-prep", "interview-prep", "notes-prep", "resume-builder", "milano"],
